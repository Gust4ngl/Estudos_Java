...
import br.com.Gusta.calc.modelo.Memoria;
...
public class Teclado extends JPanel implements ActionListener{
	...
	public Teclado() {
		...
		final Color COR_CINZA_ESCURO = new Color(46, 46, 46);
		final Color COR_CINZA_CLARO = new Color(99, 99, 99);
		final Color COR_LARANJA = new Color(242, 163, 60);
	...
	private void adicionarBotao(String string, Color cor, GridBagConstraints c,
			int x, int y) {
